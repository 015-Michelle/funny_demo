        ...
        slivers: <Widget>[
          SliverPersistentHeader(
            ...
            delegate: SliverCustomHeaderDelegate(
              ...
              paddingTop: 27.0,
              coverImgUrl: "http://img1.mukewang.com/5c18cf540001ac8206000338.jpg",
              title: "练习",
            ),
          ),
          SliverFillRemaining(
                    ...
                    children: <Widget>[
                      IconButton(
                        icon: Icon(
                          ...
                          color: makeStickyHeaderTextColor(shrinkOffset, true), // 返回图标颜色
                        ),
                      ...
                      IconButton(
                        icon: Icon(
                          Icons.share,
                          color: makeStickyHeaderTextColor(shrinkOffset, true), // 分享图标颜色
                        ),
                        onPressed: () {},
                      ),
                    ],
